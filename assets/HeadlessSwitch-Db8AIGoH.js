import{r as s,a as o,j as e}from"./index-P2HWq5AB.js";import{C as h}from"./CardBox-iBHS77gx.js";import{C as u}from"./CodeModal-ZdVmlQAl.js";import{$ as te,a as ne}from"./useFocusRing-Di4h4CvJ.js";import{w as se}from"./use-active-press-C4eQ0n2y.js";import{l as le,T as re}from"./use-default-value-877t43tv.js";import{K as ie,L as H,p as de,o as N,_ as ce}from"./render-BKlKWd6j.js";import{e as oe}from"./use-resolve-button-type-CWZZrYkE.js";import{y as he}from"./use-sync-refs-CHG90QLp.js";import{a as ue}from"./disabled-CgoTiXBv.js";import{j as ge,p as be,H as d}from"./field-BPMTWBig.js";import{Q as c,K as xe,u as me,I as pe}from"./label-CN3rczfl.js";import{r as fe}from"./bugs-DpEN4NTH.js";import{H as we,w as ke,U as Ne}from"./description-CBNApkT-.js";import{o as B}from"./keyboard-C1Wiwm26.js";import{B as je}from"./BreadcrumbComp-BnVnHUMk.js";import"./toConsumableArray-B7RXd_Ox.js";import"./extends-CF3RwP-h.js";import"./core-DD6kpHa4.js";import"./owner-CBjDaIWd.js";import"./hidden-BgX8pakw.js";let z=s.createContext(null);z.displayName="GroupContext";let ye=s.Fragment;function Se(a){var t;let[r,m]=s.useState(null),[j,y]=xe(),[S,i]=ke(),p=s.useMemo(()=>({switch:r,setSwitch:m}),[r,m]),C={},v=a,f=H();return o.createElement(i,{name:"Switch.Description",value:S},o.createElement(y,{name:"Switch.Label",value:j,props:{htmlFor:(t=p.switch)==null?void 0:t.id,onClick(w){r&&(w.currentTarget instanceof HTMLLabelElement&&w.preventDefault(),r.click(),r.focus({preventScroll:!0}))}}},o.createElement(z.Provider,{value:p},f({ourProps:C,theirProps:v,slot:{},defaultTag:ye,name:"Switch.Group"}))))}let Ce="button";function ve(a,t){var r;let m=s.useId(),j=me(),y=ue(),{id:S=j||`headlessui-switch-${m}`,disabled:i=y||!1,checked:p,defaultChecked:C,onChange:v,name:f,value:w,form:R,autoFocus:k=!1,...I}=a,E=s.useContext(z),[K,M]=s.useState(null),O=s.useRef(null),W=he(O,t,E===null?null:E.setSwitch,M),g=le(C),[b,x]=re(p,v,g??!1),G=de(),[F,$]=s.useState(!1),L=N(()=>{$(!0),x==null||x(!b),G.nextFrame(()=>{$(!1)})}),A=N(l=>{if(fe(l.currentTarget))return l.preventDefault();l.preventDefault(),L()}),U=N(l=>{l.key===B.Space?(l.preventDefault(),L()):l.key===B.Enter&&be(l.currentTarget)}),V=N(l=>l.preventDefault()),_=pe(),q=Ne(),{isFocusVisible:D,focusProps:J}=te({autoFocus:k}),{isHovered:T,hoverProps:Q}=ne({isDisabled:i}),{pressed:P,pressProps:X}=se({disabled:i}),Y=s.useMemo(()=>({checked:b,disabled:i,hover:T,focus:D,active:P,autofocus:k,changing:F}),[b,T,D,P,i,F,k]),Z=ce({id:S,ref:W,role:"switch",type:oe(a,K),tabIndex:a.tabIndex===-1?0:(r=a.tabIndex)!=null?r:0,"aria-checked":b,"aria-labelledby":_,"aria-describedby":q,disabled:i||void 0,autoFocus:k,onClick:A,onKeyUp:U,onKeyPress:V},J,Q,X),ee=s.useCallback(()=>{if(g!==void 0)return x==null?void 0:x(g)},[x,g]),ae=H();return o.createElement(o.Fragment,null,f!=null&&o.createElement(ge,{disabled:i,data:{[f]:w||"on"},overrides:{type:"checkbox",checked:b},form:R,onReset:ee}),ae({ourProps:Z,theirProps:I,slot:Y,defaultTag:Ce,name:"Switch"}))}let ze=ie(ve),Ee=Se,Fe=c,$e=we,n=Object.assign(ze,{Group:Ee,Label:Fe,Description:$e});const Le=()=>e.jsx("div",{children:e.jsx(u,{children:`
