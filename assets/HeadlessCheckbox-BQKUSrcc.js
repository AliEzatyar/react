import{r as s,a as v,j as e}from"./index-CbdGNVhE.js";import{$ as q,a as J}from"./useFocusRing-CXvZpW1I.js";import{w as Y}from"./use-active-press-B171Jcqa.js";import{l as Z,T as ee}from"./use-default-value-xkMuo3m4.js";import{K as se,p as ae,o as j,_ as te,L as ie}from"./render-NI4Jg5tu.js";import{a as oe}from"./disabled-DeIIXrEU.js";import{j as ce,p as re,H as i}from"./field-Bz5zx8cw.js";import{u as ne,I as le,Q as o}from"./label-MdCs77Yl.js";import{r as de}from"./bugs-DpEN4NTH.js";import{U as he,H as xe}from"./description-UBmOgCgm.js";import{o as F}from"./keyboard-C1Wiwm26.js";import{C as h}from"./CardBox-DWufozWR.js";import{C as x}from"./CodeModal-CQLFjqdl.js";import{c as S}from"./clsx-B-dksMZM.js";import{B as be}from"./BreadcrumbComp-B5-q4JsV.js";import"./owner-fH536Zf5.js";import"./hidden-BpERx2SG.js";import"./use-sync-refs-BkeMvBOG.js";import"./Card-DYrQhspN.js";import"./toConsumableArray-CGYUFXbV.js";import"./extends-CF3RwP-h.js";let pe="span";function me(a,t){let r=s.useId(),n=ne(),b=oe(),{id:p=n||`headlessui-checkbox-${r}`,disabled:l=b||!1,autoFocus:f=!1,checked:B,defaultChecked:M,onChange:T,name:N,value:$,form:D,indeterminate:g=!1,...U}=a,m=Z(M),[u,k]=ee(B,T,m??!1),H=le(),A=he(),P=ae(),[L,y]=s.useState(!1),C=j(()=>{y(!0),k==null||k(!u),P.nextFrame(()=>{y(!1)})}),R=j(d=>{if(de(d.currentTarget))return d.preventDefault();d.preventDefault(),C()}),z=j(d=>{d.key===F.Space?(d.preventDefault(),C()):d.key===F.Enter&&re(d.currentTarget)}),I=j(d=>d.preventDefault()),{isFocusVisible:w,focusProps:K}=q({autoFocus:f}),{isHovered:W,hoverProps:_}=J({isDisabled:l}),{pressed:E,pressProps:G}=Y({disabled:l}),O=te({ref:t,id:p,role:"checkbox","aria-checked":g?"mixed":u?"true":"false","aria-labelledby":H,"aria-describedby":A,"aria-disabled":l?!0:void 0,indeterminate:g?"true":void 0,tabIndex:l?void 0:0,onKeyUp:l?void 0:z,onKeyPress:l?void 0:I,onClick:l?void 0:R},K,_,G),Q=s.useMemo(()=>({checked:u,disabled:l,hover:W,focus:w,active:E,indeterminate:g,changing:L,autofocus:f}),[u,g,l,W,w,E,L,f]),V=s.useCallback(()=>{if(m!==void 0)return k==null?void 0:k(m)},[k,m]),X=ie();return v.createElement(v.Fragment,null,N!=null&&v.createElement(ce,{disabled:l,data:{[N]:$||"on"},overrides:{type:"checkbox",checked:u},form:D,onReset:V}),X({ourProps:O,theirProps:U,slot:Q,defaultTag:pe,name:"Checkbox"}))}let c=se(me);const ue=()=>e.jsx("div",{children:e.jsx(x,{children:`
