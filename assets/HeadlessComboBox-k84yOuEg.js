import{r as d,aA as se,a as _,j as s,I as qe}from"./index-CbdGNVhE.js";import{C as K}from"./CardBox-DWufozWR.js";import{$ as tt,a as ot}from"./useFocusRing-CXvZpW1I.js";import{w as ut}from"./use-active-press-B171Jcqa.js";import{u as mt}from"./use-by-comparator-BYOBCm-o.js";import{l as pt,T as ht}from"./use-default-value-xkMuo3m4.js";import{o as y,O as Qe,K as he,u as ie,n as te,L as be,p as bt,_ as Fe,s as xt,b as He}from"./render-NI4Jg5tu.js";import{M as ft,y as gt,x as vt,R as yt,b as wt,d as Ue}from"./floating-NclsgDUm.js";import{y as Ct}from"./use-inert-others-oUvP3Aj6.js";import{R as St,n as nt,m as jt,f as kt,r as Ot,a as Et}from"./portal-BwguBjbq.js";import{E as Pt}from"./use-event-listener-hcH-Y6pZ.js";import{e as It}from"./use-resolve-button-type-CgW3LA2y.js";import{y as ye}from"./use-sync-refs-BkeMvBOG.js";import{u as Tt,c as T,f as Ge}from"./calculate-active-index-B7Hubdxh.js";import{c as Nt,i as ve,u as Rt,x as Mt,R as Dt}from"./open-closed-Ds_Qw___.js";import{F as $t}from"./use-tree-walker-DDsdCBnX.js";import{m as Je,r as Xe}from"./active-element-history-Bh-9dXkb.js";import{a as Lt}from"./disabled-DeIIXrEU.js";import{j as zt,H as le}from"./field-Bz5zx8cw.js";import{l as Ye,f as Kt}from"./frozen-Bj1yxvo-.js";import{K as Ft,u as At,I as Ae,Q as we}from"./label-MdCs77Yl.js";import{r as Bt}from"./bugs-DpEN4NTH.js";import{_ as _t}from"./focus-management-CnjimqFj.js";import{U as Vt}from"./description-UBmOgCgm.js";import{o as W}from"./keyboard-C1Wiwm26.js";import{C as de}from"./CodeModal-CQLFjqdl.js";import{c as Ze}from"./clsx-B-dksMZM.js";import{A as Wt,m as qt}from"./index-DVVV_Nxn.js";import{B as Qt}from"./BreadcrumbComp-B5-q4JsV.js";import"./Card-DYrQhspN.js";import"./owner-fH536Zf5.js";import"./use-server-handoff-complete-DVUiotRc.js";import"./hidden-BpERx2SG.js";import"./toConsumableArray-CGYUFXbV.js";import"./extends-CF3RwP-h.js";function ae(e,a,o){let n=o.initialDeps??[],r;return()=>{var t,i,l,c;let m;o.key&&((t=o.debug)!=null&&t.call(o))&&(m=Date.now());const p=e();if(!(p.length!==n.length||p.some((u,S)=>n[S]!==u)))return r;n=p;let w;if(o.key&&((i=o.debug)!=null&&i.call(o))&&(w=Date.now()),r=a(...p),o.key&&((l=o.debug)!=null&&l.call(o))){const u=Math.round((Date.now()-m)*100)/100,S=Math.round((Date.now()-w)*100)/100,C=S/16,x=(k,V)=>{for(k=String(k);k.length<V;)k=" "+k;return k};console.info(`%c⏱ ${x(S,5)} /${x(u,5)} ms`,`
    ...
    `})}),Re=[{id:1,name:"Durward Reynolds"},{id:2,name:"Kenton Towne"},{id:3,name:"Therese Wunsch"},{id:4,name:"Benedict Kessler"},{id:5,name:"Katelyn Rohan"}],Ao=()=>{const[e,a]=d.useState(Re[0]),[o,n]=d.useState(""),r=o===""?Re:Re.filter(t=>t.name.toLowerCase().includes(o.toLowerCase()));return s.jsx("div",{children:s.jsxs(K,{children:[s.jsxs("div",{className:"flex items-center justify-between mb-2",children:[s.jsx("h4",{className:"text-lg font-semibold",children:"Disabled"}),s.jsx(Fo,{})]}),s.jsxs(le,{className:"flex gap-3  items-center",disabled:!0,children:[s.jsx(we,{className:"text-ld",children:"Select:"}),s.jsxs(F,{value:e,onChange:a,onClose:()=>n(""),children:[s.jsx(R,{displayValue:t=>t?t.name:"",onChange:t=>n(t.target.value),className:"w-full ui-form-control rounded-md"}),s.jsx(M,{anchor:"bottom",className:"absolute z-10 mt-1 max-h-60 w-[var(--input-width)] overflow-auto rounded-md bg-white dark:bg-dark py-1 text-base shadow-md dark:shadow-dark-md ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm empty:invisible",children:r.map(t=>s.jsx(D,{value:t,className:"group flex cursor-pointer ui-dropdown-item bg-hover dark:bg-hover text-ld hover:text-primary dark:hover:text-primary  data-[focus]:bg-hover data-[focus]:text-primary",children:t.name},t.id))})]})]})]})})},Bo=()=>s.jsx("div",{children:s.jsx(de,{children:`
    ...
    `})}),ze=[{id:1,name:"Durward Reynolds"},{id:2,name:"Kenton Towne"},{id:3,name:"Therese Wunsch"},{id:4,name:"Benedict Kessler"},{id:5,name:"Katelyn Rohan"}],Go=()=>{const[e,a]=d.useState(ze[0]),[o,n]=d.useState(""),r=o===""?ze:ze.filter(t=>t.name.toLowerCase().includes(o.toLowerCase()));return s.jsx("div",{children:s.jsxs(K,{children:[s.jsxs("div",{className:"flex items-center justify-between mb-2",children:[s.jsx("h4",{className:"text-lg font-semibold",children:"With Label"}),s.jsx(Uo,{})]}),s.jsxs(le,{className:"flex gap-3  items-center",children:[s.jsx(we,{className:"text-ld",children:"Assignee:"}),s.jsxs(F,{value:e,onChange:a,onClose:()=>n(""),children:[s.jsx(R,{displayValue:t=>t?t.name:"",onChange:t=>n(t.target.value),className:"w-full ui-form-control rounded-md"}),s.jsx(M,{anchor:"bottom",className:"absolute z-10 mt-1 max-h-60 w-[var(--input-width)] overflow-auto rounded-md bg-white dark:bg-dark py-1 text-base shadow-md dark:shadow-dark-md ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm empty:invisible",children:r.map(t=>s.jsx(D,{value:t,className:"group flex cursor-pointer ui-dropdown-item bg-hover dark:bg-hover text-ld hover:text-primary dark:hover:text-primary  data-[focus]:bg-hover data-[focus]:text-primary",children:t.name},t.id))})]})]})]})})},Ke=[{id:1,name:"Durward Reynolds"},{id:2,name:"Kenton Towne"},{id:3,name:"Therese Wunsch"},{id:4,name:"Benedict Kessler"},{id:5,name:"Katelyn Rohan"}],Jo=()=>{const[e,a]=d.useState(Ke[0]),[o,n]=d.useState(""),r=o===""?Ke:Ke.filter(t=>t.name.toLowerCase().includes(o.toLowerCase()));return s.jsx("div",{children:s.jsxs(K,{children:[s.jsx("div",{className:"flex items-center justify-between mb-2",children:s.jsx("h4",{className:"text-lg font-semibold",children:"With Transitions"})}),s.jsx(le,{children:s.jsxs(F,{value:e,onChange:a,onClose:()=>n(""),children:[s.jsx(R,{displayValue:t=>t?t.name:"",onChange:t=>n(t.target.value),className:"w-full ui-form-control rounded-md"}),s.jsx(M,{transition:!0,anchor:"bottom",className:"origin-top border transition duration-200 ease-out empty:invisible data-[closed]:scale-95 data-[closed]:opacity-0 absolute z-10 mt-1 max-h-60 w-[var(--input-width)]  overflow-auto rounded-md bg-white dark:bg-dark py-1 text-base shadow-md dark:shadow-dark-md ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm empty:invisible",children:r.map(t=>s.jsx(D,{value:t,className:"group flex cursor-pointer ui-dropdown-item bg-hover dark:bg-hover text-ld hover:text-primary dark:hover:text-primary  data-[focus]:bg-hover data-[focus]:text-primary",children:t.name},t.id))})]})})]})})},Mn=()=>{const e=[{to:"/",title:"Home"},{title:"Combobox"}];return s.jsxs(s.Fragment,{children:[s.jsx(Qt,{title:"Combobox",items:e}),s.jsxs("div",{className:"grid grid-cols-12 gap-30",children:[s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Ro,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Go,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Ao,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(_o,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(To,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(zo,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Ko,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Jo,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Ho,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Mo,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx($o,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(qo,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Do,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Po,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Qo,{})}),s.jsx("div",{className:"lg:col-span-4 md:col-span-6 col-span-12",children:s.jsx(Vo,{})})]})]})};export{Mn as default};
