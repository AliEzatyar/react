import{r as o,aK as D,aL as E,bA as O,bB as S,bC as T,j as e,bD as z,bE as W,a3 as J,B as s,aP as Y,p as l,b as d,aa as U}from"./index-CbdGNVhE.js";import{C as t}from"./CardBox-DWufozWR.js";import{C as c}from"./CodeModal-CQLFjqdl.js";import{B as G}from"./BreadcrumbComp-B5-q4JsV.js";import"./Card-DYrQhspN.js";import"./toConsumableArray-CGYUFXbV.js";import"./extends-CF3RwP-h.js";function a({children:r,content:n,theme:v={},arrow:j=!0,trigger:u="click",initialOpen:b,open:y,onOpenChange:f,placement:N="bottom",...w}){const[k,P]=o.useState(!!b),p=o.useRef(null),i=D(E().popover,v),x=y??k,B=O({open:x,placement:N,arrowRef:p,setOpen:f??P}),{floatingStyles:I,context:m,placement:C,middlewareData:{arrow:{x:F,y:A}={}},refs:R}=B,{getFloatingProps:L,getReferenceProps:h}=S({context:m,role:"dialog",trigger:u}),M=r.ref,g=T([m.refs.setReference,M]);if(!o.isValidElement(r))throw Error("Invalid target element");const q=o.useMemo(()=>o.cloneElement(r,h({ref:g,"data-testid":"flowbite-popover-target",...r==null?void 0:r.props})),[r,g,h]);return e.jsxs(e.Fragment,{children:[q,x&&e.jsx(z,{context:m,modal:!0,children:e.jsx("div",{className:i.base,ref:R.setFloating,"data-testid":"flowbite-popover",...w,style:I,...L(),children:e.jsxs("div",{className:"relative",children:[j&&e.jsx("div",{className:i.arrow.base,"data-testid":"flowbite-popover-arrow",ref:p,style:{top:A??" ",left:F??" ",right:" ",bottom:" ",[W({placement:C})]:i.arrow.placement},children:" "}),e.jsx("div",{className:i.content,children:n})]})})})]})}const H=()=>e.jsx("div",{children:e.jsxs(t,{children:[e.jsxs("div",{className:"flex items-center justify-between mb-2",children:[e.jsx("h4",{className:"text-lg font-semibold",children:"Company Profile"}),e.jsx(c,{children:`
